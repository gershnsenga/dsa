/**
 * This file contains the file to do operations on two sparse matrices. 
 * 
 */
...
function main() {
  const firstmatrixFilePath = '../sample_inputs/matrix1.txt';
  const secondmatrixFilePath = '../sample_inputs/matrix2.txt';
  ...
  const outputAddPath = '../sample_results/addition_result.txt';
  const outputSubPath =
    '../sample_results/substration_result.txt';
